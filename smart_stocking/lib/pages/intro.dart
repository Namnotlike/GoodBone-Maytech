  ...
  Widget build(BuildContext context) {
    ...
    final PageViewModel page1 = PageViewModel(
        ...
        image: Container(
          ...
          height: 250,
          width: 250,
          image: AssetImage(Config.introImage1),
          fit: BoxFit.fitHeight,
        ),// SvgPicture.asset(Config.introImage1),
        ));
    ...
    final PageViewModel page2 = PageViewModel(
        ...
        image: Container(
          ...
          height: 250,
          width: 250,
          image: AssetImage(Config.introImage2),
          fit: BoxFit.fitHeight,
        ),//SvgPicture.asset(Config.introImage2),
        ));
    ...
    final PageViewModel page3 = PageViewModel(
        ...
        image: Container(
          ...
          height: 250,
          width: 250,
          image: AssetImage(Config.introImage3),
          fit: BoxFit.fitHeight,
        ),//SvgPicture.asset(Config.introImage3),
        ));
